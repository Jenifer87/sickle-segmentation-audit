...
> **Segmentation errors that track the disease: a globally scaled seed threshold biases the sickle fraction in automated blood film analysis**
> A. Philomina Jenifer, Priti Rishi. Submitted to *Medical & Biological Engineering & Computing*.
...
1. Run `paper-2.ipynb` on Kaggle (Python 3.12, OpenCV, scikit-image, SciPy, pandas, statsmodels; SAM ViT-B and Cellpose-SAM need a GPU only for ground-truth generation and the learned reference).
2. Regenerate the figures from the CSVs:
